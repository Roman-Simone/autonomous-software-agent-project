...
class PddlPickUp extends Plan {
    ...
    //     var pddlProblem = new PddlProblem(
    //         'deliveroo',
    //         MyMap.myBeliefset.objects.join(' ') + ' ' + parcel.id,
    //         MyMap.myBeliefset.toPddlString() + ' (at t' + MyData.pos.x + '_' + MyData.pos.y + ')' + ' (parcel_at ' + parcel.id + ' t' + x + '_' + y + ')',
    //         goal
    //     );
...
class PddlPutDown extends Plan {
    ...
    //     var allParcelsInMind = MyData.getParcelsInMindIds(); 

    //     // if (allParcelsInMind.length == 0) {
    //     //     console.log("No parcels in mind");
    //     //     return false;
    //     // } 


    //     let goal = 'and (at t' + x + '_' + y + ') ';
    //     let obj_parcels = '';
    //     let init_parcels = '';


    //     for (let parcel of allParcelsInMind) {

    //         goal += '( not (carrying ' + parcel.id + ')) ';
    //         // console.log("Parcel: ", parcel.id);    

    //         obj_parcels += parcel.id + ' ';
    //         init_parcels += '(carrying ' + parcel.id + ') '
    //     }

    //     // console.log("All parcels: ", obj_parcels);
        
    //     // console.log("Goal: ", goal);
        
    //     // console.log("Init parcels: ", init_parcels);


    //     // Create the PDDL problem
    //     var pddlProblem = new PddlProblem(
    //         'deliveroo',
    //         MyMap.myBeliefset.objects.join(' ') + ' ' + obj_parcels,
    //         MyMap.myBeliefset.toPddlString() + ' (at t' + MyData.pos.x + '_' + MyData.pos.y + ') ' + init_parcels,
    //         goal
    //     );
